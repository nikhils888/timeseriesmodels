# # Time Series Models 🚀
#
# # This repository provides an organized structure to run multiple **time series forecasting models** (e.g., Time-LLM, others).  
# # Each model has its own folder with a `run.sh` script, and you can launch them easily using the `main.sh` script.
#
# # ---
#
